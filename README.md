...
**README**  
* Anna Subramaniam, anna.l.subramaniam@vanderbilt.edu
...
Vite will provide a local URL (typically http://localhost:5173). Open that URL in a web browser to use the application.
